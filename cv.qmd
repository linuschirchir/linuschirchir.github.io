...
<div class="centered" style="margin-top:0.5rem; margin-bottom:1.5rem;">
  <a href="files/CV_Linus_Chirchir.pdf"
...
::: {.d-flex style="align-items:baseline"}
::: p-2
[![](images/rss_logo.PNG){width="80px" fig-alt="RSS Logo"}](https://rss.org.uk/)
:::
...
::: {.d-flex style="align-items:baseline"}
::: p-2
[![](images/apha_logo.PNG){width="80px" fig-alt="AphA Logo"}](https://www.aphanalysts.org/)
:::
