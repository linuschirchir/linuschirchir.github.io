...
format: 
  html:
    page-title: "Curriculum Vitae"  # Sets the HTML page title
---
...
Here is the modified version with the links set to open in new tabs:
...
Here is the modified version without the headings:
...
### <i class="fas fa-file-alt"></i> Peer Reviewed Journal Articles
